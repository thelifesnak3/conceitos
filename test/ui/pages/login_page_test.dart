...
void main() {
  ...
  testWidgets('Should enable button if TextFormFields is valid', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should disable button if TextFormFields is invalid', (WidgetTester tester) async {
    await loadPage(tester);
  ...
  testWidgets('Should hidden loading', (WidgetTester tester) async {
    await loadPage(tester);
